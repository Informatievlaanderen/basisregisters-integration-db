namespace Basisregisters.IntegrationDb.Schema.Models.Views.SuspiciousCases
{
    ...
    public sealed class ActiveBuildingUnitWithoutAddressConfiguration : IEntityTypeConfiguration<ActiveBuildingUnitWithoutAddress>
    {
        ...
        {
            builder
                .ToView(nameof(ActiveBuildingUnitWithoutAddress), SuspiciousCasesContext.Schema)
                .HasNoKey()
                .ToSqlQuery(@$"SELECT
        ...
        public const string ViewName = @$"""{SuspiciousCasesContext.Schema}"".""VIEW_{nameof(ActiveBuildingUnitWithoutAddress)}""";
