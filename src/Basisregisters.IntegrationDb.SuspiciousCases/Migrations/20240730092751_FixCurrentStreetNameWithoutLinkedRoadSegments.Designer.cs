...
namespace Basisregisters.IntegrationDb.SuspiciousCases.Migrations
{
    ...
    [Migration("20240730092751_FixCurrentStreetNameWithoutLinkedRoadSegments")]
    partial class FixCurrentStreetNameWithoutLinkedRoadSegments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Basisregisters.IntegrationDb.SuspiciousCases.Views.MeasuredRoadSegmentWithNoOrSingleLinkedStreetName", b =>
                {
                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.ToView("view_measured_road_segment_with_no_or_single_linked_streetname", "integration_suspicious_cases");

                    b.ToSqlQuery("\r\n                            SELECT\r\n                                persistent_local_id,\r\n                                road_segment_persistent_local_id,\r\n                                nis_code,\r\n                                CONCAT('Wegsegment-', road_segment_persistent_local_id) as description\r\n                            FROM integration_suspicious_cases.view_measured_road_segment_with_no_or_single_linked_streetname");
                });
