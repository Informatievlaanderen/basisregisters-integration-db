...
//         {
//             builder
//                 .ToView(nameof(AddressesLinkedToMultipleBuildingUnits), SuspiciousCasesContext.Schema)
//                 .HasNoKey()
//                 .ToSqlQuery(@$"
//                             SELECT
...
//
//
//         public const string ViewName = @$"""{SuspiciousCasesContext.Schema}"".""VIEW_{nameof(AddressesLinkedToMultipleBuildingUnits)}""";
//
