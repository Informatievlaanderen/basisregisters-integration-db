namespace Basisregisters.IntegrationDb.DataIntegrity.Infrastructure
{
    using System;
    using System.IO;
    ...
    public sealed class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Initializing IntegrationDb.DataIntegrity");
            ...
            var host = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton<IFeedIntegrityRepository, BuildingUnitAddressViewRepository>();
            ...
            Log.Information("Starting IntegrationDb.DataIntegrity");
