...
namespace Basisregisters.IntegrationDb.Gtmf.Meldingen.Migrations
{
    ...
    [Migration("20250121193845_RenameToInitiatorOrganisatie")]
    partial class RenameToInitiatorOrganisatie
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Basisregisters.IntegrationDb.Gtmf.Meldingen.MeldingsobjectStatuswijziging", b =>
                {
                    ...
                    b.Property<Guid>("InitiatorOrganisatieIdInternal")
                        .HasColumnType("uuid")
                        .HasColumnName("initiator_organisatie_id_internal");
                    ...
                    b.HasIndex("InitiatorOrganisatieIdInternal");
