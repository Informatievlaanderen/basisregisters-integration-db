namespace Basisregisters.IntegrationDb.Bosa.Tests
{
    ...
    public class XmlStreetNameTests
    {
        ...
        public XmlStreetNameTests()
        {
            _given =
            [
                new StreetName(StreetNameNamespace, "1500", new DateTimeOffset(1900, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "HALLE", "2002-08-13T16:37:33"),
                new StreetName(StreetNameNamespace, "1600", new DateTimeOffset(2002, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "FAKE", null),
                new StreetName(StreetNameNamespace, "3890", new DateTimeOffset(2024, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "Boekhout", "2002-08-13T16:37:33"),
                new StreetName(StreetNameNamespace, "3890", new DateTimeOffset(2024, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "GINGELOM", "2002-08-13T16:37:33"),
                new StreetName(StreetNameNamespace, "3890", new DateTimeOffset(2024, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "Jeuk", "2002-08-13T16:37:33"),
                new StreetName(StreetNameNamespace, "3890", new DateTimeOffset(2024, 08, 13, 14, 37, 33, TimeSpan.FromHours(2)), "Vorsen", "2002-08-13T16:37:33")
            ];
        }
            ...
            var expected =
                ...
                <tns:streetNameResponseBySource xmlns:com="http://fsb.belgium.be/data/common" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:tns="http://fsb.belgium.be/mappingservices/FullDownload/v1_00">
                  ...
                  <tns:timestamp>1970-01-01T01:00:00+01:00</tns:timestamp>
                    ...
                    <tns:streetName beginLifeSpanVersion="2016-10-03T08:46:40.257">
                       <com:code>
                          <com:namespace>https://data.vlaanderen.be/id/straatnaam</com:namespace>
                       ...
                       <com:streetNameStatus>
                          ...
                          <com:validFrom>2016-10-03T08:46:40.257</com:validFrom>
                       </com:streetNameStatus>
                       <com:type>streetname</com:type>
                       <com:isAssignedByMunicipality>
                          <com:namespace>https://data.vlaanderen.be/id/gemeente</com:namespace>
